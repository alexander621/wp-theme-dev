...
function get_default_settings() {
    $settings = [
        ...
        'tw_url'      => get_field("twitter_url", "option") ?? null,
        'ig_url'      => get_field("instagram_url", "option") ?? "#",
        'yt_url'      => get_field("youtube_url", "option") ?? "#",
        'in_url'      => get_field("linkedin_url", "option") ?? null,
        'pi_url'      => get_field("pinterest_url", "option") ?? null,
...
add_action('wp_head', function() {
    echo '<meta name="facebook-domain-verification" content="4zzolf7ubfbplr3v0srmewgg9dh7pp" />';
});